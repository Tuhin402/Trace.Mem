...
class SecurityHeaders
{
    ...
    private function applyHeaders(Request $request, Response $response): void
    {
        ...
        $csp = implode('; ', array_filter([
            ...
            "img-src 'self' data: blob: https://checkout.razorpay.com https://img.youtube.com https://i.ytimg.com",
            "font-src 'self' data: https://fonts.gstatic.com",
            "connect-src 'self' https://api.razorpay.com" . ($isLocal ? ' ws://localhost:5173 http://localhost:5173' : ''),
            "frame-src https://api.razorpay.com https://checkout.razorpay.com https://www.youtube.com https://youtube.com https://www.youtube-nocookie.com",
            "object-src 'none'",
            "base-uri 'self'",
            "form-action 'self'",
        ]));
