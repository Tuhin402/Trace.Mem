    ...
    return (
        <>
            ...
            >
                ...
                {currentTab === 'members' && (
                    <div id="members" className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        {/* Members List */}
                        <div className="w-full bg-surface border border-almost-black/10">
                            <div className="px-6 py-4 border-b border-almost-black/10 flex items-center justify-between">
                                ...
                                <button className="text-xs font-bold uppercase tracking-wider text-primary hover:underline">Invite Member</button>
                            </div>
                ...
                {currentTab === 'api-keys' && (
                    <div id="api-keys" className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        {/* API Keys */}
                        <div className="w-full bg-surface border border-almost-black/10">
                            <div className="px-6 py-4 border-b border-almost-black/10 flex items-center justify-between">
                                <h3 className="text-sm font-bold uppercase tracking-wider text-on-background">API Keys</h3>
                                <button className="text-xs font-bold uppercase tracking-wider text-primary hover:underline">Create API Key</button>
                            </div>
                            <div className="divide-y divide-almost-black/5">
                    ...
                    <div id="activity" className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                        <div className="w-full bg-surface border border-almost-black/10">
                            <div className="px-6 py-4 border-b border-almost-black/10">
                                <h3 className="text-sm font-bold uppercase tracking-wider text-on-background">Activity Log</h3>
                            </div>
                            <div className="divide-y divide-almost-black/5">
                                {workspace.recent_activity.map((log: any) => (
                                    <div key={log.id} className="p-4 flex items-center justify-between group">
                                        <div className="flex flex-col">
                                            <span className="text-sm font-bold text-on-background">{log.action}</span>
                                            <span className="text-xs text-on-background/50 font-mono">By {log.user}</span>
                                        </div>
