...
const systemPrompt = \`Context:\n\${data.context}\n\nUser: ...\`;`,
    ...
    ->post('https://tracemem.io/api/v1/context/assemble', [
        'query'        => 'Help me answer this question about frameworks',
        'token_budget' => 1200,
    ]);
...
// Inject $context into your LLM system prompt`,
                    curl: `curl -X POST "https://tracemem.io/api/v1/context/assemble" \\
...
HttpRequest request = HttpRequest.newBuilder()
    .uri(URI.create("https://tracemem.io/api/v1/context/assemble"))
